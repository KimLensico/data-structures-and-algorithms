...
const forLoopTwoToThe = (arr) => {
  // created the array so values can be populated inside the loop
  // create a for loop that takes in the values
  // run the values into the array then run the values through as the power to 2

  const array = [];
  for (const i = 0; i < array.length; i++) {
    if (array[i] !== null) {
      array.push(Math.pow(2, array[i]));
    };
  }; return array;
};
...
const forEachTwoToThe = (arr) => {
  // created the array so values can be populated inside the loop
  // create a forEach loop that takes in the values
  // run the values into the array then run the values through as the power to 2
...
const mapTwoToThe = (arr) => {
  // create the array so values can be populated inside the loop
  // create a map loop that takes in the values
  // run the values into the array then run the values through as the power to 2
  const array = [];
  arr.map(i => {
    array.push(Math.pow(2, i));
